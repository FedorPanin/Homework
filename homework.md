...
### 3. `Команда для загрузки удаленного репозитория`

```
git clone <url>
```

### 4. `Команда для загрузки изменений в локальный репозиторий из удаленного`

```
git pull
```

### 5. `Команда для загрузки изменений в удаленный репозиторий из локального`
